...
class LLMHandler:
    ...
    def query_to_reform(self, query: str, histories):
        messages = [
            {
                'role': 'system',
                'content': f"""Given a chat history and the latest user questions 
                    ...
                    Use json format to response answer

                    [chat history] 
                    {histories}
                    
                    [response format]
                    {{'user_question': 'reformulated user questions'}}
                """
            },
    ...
    async def query_to_reform_stream(self, query: str, histories):
        messages = [
            {
                'role': 'system',
                'content':f"""Given a chat history and the latest user questions 
